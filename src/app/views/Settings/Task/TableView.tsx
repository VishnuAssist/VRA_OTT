        ...
        <TableContainer sx={{overflow:"auto"}} >
          <Table>
            ...
            <TableRow>
                ...
                <TableCell ><Tooltip title={<Box>Assigned</Box>} arrow><CircleRoundedIcon sx={{color:"#973FCF", fontSize:'6'}}/></Tooltip></TableCell>
                <TableCell sx={{fontSize:'12px'}}>Rizwan</TableCell>
                <TableCell sx={{fontSize:'12px'}}>Task 01</TableCell>
                <TableCell sx={{fontSize:'12px'}}>task assigned by staff</TableCell>
                <TableCell align="center" sx={{  textTransform: "capitalize" }}>
                
                   <Box display="flex" alignItems="center" position="relative" marginLeft="-0.875rem !important">
              ...
              <StyledAvatar onClick={handleProfileclick} sx={{ fontSize: "14px" }}>+3</StyledAvatar>
            ...
            <TableCell sx={{fontSize:'12px'}}>AUG 01</TableCell>
                <TableCell ><IconButton
                        ...
                        color="error"
                        aria-label="delete"><DeleteIcon /></IconButton> </IconButton></TableCell>
                
              </TableRow>
              <TableRow>
                
              
                <TableCell ><Tooltip title={<Box>On progress</Box>} arrow><CircleRoundedIcon sx={{color:"#FFA500", fontSize:'6'}}/></Tooltip></TableCell>
                <TableCell sx={{fontSize:'12px'}}>Rizwan</TableCell>
            ...
            <TableCell sx={{fontSize:'12px'}}>AUG 01</TableCell>
              ...
              <TableRow>
                ...
                <TableCell ><Tooltip title={<Box>Completed</Box>} arrow><CircleRoundedIcon sx={{color:"#68B266", fontSize:'6'}}/></Tooltip></TableCell>
                <TableCell sx={{fontSize:'12px'}}>Rizwan</TableCell>
                <TableCell sx={{fontSize:'12px'}}>Task 02</TableCell>
                <TableCell sx={{fontSize:'12px'}}>task assigned by staff</TableCell>
                <TableCell align="center" sx={{  textTransform: "capitalize" }}>
